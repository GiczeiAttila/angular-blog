...
@Component
public class PostFormDataValidator implements Validator {
    @Override
    public boolean supports(Class<?> aClass) {
        return PostFormData.class.equals(aClass);
    }

    @Override
    public void validate(Object o, Errors errors) {
        PostFormData postFormData = (PostFormData) o;

        if (postFormData.getTitle() == null || postFormData.getTitle().isEmpty()) {
